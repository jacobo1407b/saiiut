    ...
    >
      <div id="fixedPluginClasses" className={props.fixedClasses}>
        ...
        <ul className="dropdown-menu">
          <li className="header-title">Personaliza tu panel</li>
